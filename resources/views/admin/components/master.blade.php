...
<body id="kt_body"  @if (session()->get('lang') == 'ar' or app()->getLocale() == 'ar')
    direction="rtl" @endif class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed aside-enabled aside-static page-loading">

<!--begin::Main-->
<div class="page-loader page-loader-logo">
    <img onerror="this.src='{{asset('assets/assets/images/no-image.jpg')}}';"
         alt="{{ config('app.title') }}" width="128" height="auto" src="{{asset('images/logo.png')}}"/>
