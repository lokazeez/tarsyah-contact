    ...
    function renderHorMenu($item, $parent = null, $rec = 0)
    {
        ...
        if (isset($item['separator'])) {
            ...
            if (isset($item['submenu'])) {
                ...
                if (($item['submenu']['type'] == 'mega') && isset($item['root']) && isset($item['align']) && $item['align'] != 'center') {
                    $item_class .= ' menu-item-rel';
                }
            ...
            if (isset($item['icon-only']) && $item['icon-only']) {
            ...
            if (isset($item['code'])) {
                ...
                if ((isset($item['heading']) && $item['heading'] && isset($item['bullet']) && $item['bullet'] == 'dot') || (isset($parent['bullet']) && $parent['bullet'] == 'dot')) {
                    $bullet = 'dot';
                } elseif ((isset($item['heading']) && $item['heading'] && isset($item['bullet']) && $item['bullet'] == 'line') || ( isset($parent['bullet']) && $parent['bullet'] == 'line')) {
                    $bullet = 'line';
                }
                ...
                if (isset($item['submenu'])) {
                    if (in_array($item['submenu']['type'], array('classic', 'tabs'))) {
                        ...
                        if (isset($item['submenu']['width']) && intval($item['submenu']['width']) > 0) {
